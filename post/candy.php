...
if(isset($_SESSION['tokn']) && $_POST['tokn'] == $_SESSION['tokn']) {
	...
	$sql1="INSERT INTO `logs` (`to`, `from`, `kind`, `amount`, `back`, `after`) VALUES ('$hakbun', '$name', '상품교환(사탕)', '1', '$or_card', '$card')";
	mysqli_query($connect,$sql1);
	mysqli_query($connect,$sql);
	 echo  "<script>window.alert('상품교환(사탕)을 완료 했습니다.');window.location.href='/admin/gifts';</script>";
	}
} else {
}
